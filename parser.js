...
(function () {
  ...
  function exerciseHistory(workout, exerciseName) {
    const out = [];
  ...
  function exerciseHistoryAll(workouts, exerciseName) {
    const out = [];
    workouts.forEach(w => {
  ...
  window.WorkoutParser = {
    parseCSV,
    buildModel,
    exerciseHistory,
    exerciseHistoryAll,
    rpeToRir,
    fmtDate, fmtDateShort, fmtTime, fmtRelative,
  };
})();
